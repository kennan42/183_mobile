        ...
        for (var i in addedUser) {
            var pushArg = {
               ...
               // platforms : "0,1",
                ...
                body : new Date().getTime() + "_" + addedUser[i].userId + "_CarpoolJourneyIssueAddPassenger",
                userCodeListStr : addedUser[i].userId,
              //  badgeNum : 3,
                module:"Carpool",
...
function pushMsgDelay(travelId) {
    ...
    setTimeout(function() {
        ...
        //推送消息
        function(callback) {
            console.log("---------------->push message start",userIds);
            for (var i in userIds ) {
                ...
                var pushArg = {
                  ...
                  //  platforms : "0,1",
                    title : title,
                    body:new Date().getTime() + "_" + userIds[i].userId + "_CarpoolJourneyIssue",
                    userCodeListStr : userIds[i].userId,
                    badgeNum : 3,
                    module:"Carpool",
