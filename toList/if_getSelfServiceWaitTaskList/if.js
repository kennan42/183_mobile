...
function run(Param, Robot, Request, Response, IF) {
    ...
    if (!("channelSerialNo" in arg && "currUsrId" in arg && "pageNum" in arg && "pageSize" in arg)) {
 ...
 * @constructor
 */
function PORTALBPMIAIWaitTaskListImplBean(Param, Robot, pageNum, pageSize, cb) {
    var arg = JSON.parse(Param.body.toString());
    var option = {
        method: "POST",
